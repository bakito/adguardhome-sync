...
mocks: tb.mockgen
	$(TB_MOCKGEN) -package client -build_constraint "!ignore_autogenerated" -destination internal/mocks/client/mock.go github.com/bakito/adguardhome-sync/internal/client Client
	$(TB_MOCKGEN) -package client -build_constraint "!ignore_autogenerated" -destination internal/mocks/flags/mock.go github.com/bakito/adguardhome-sync/internal/config Flags
