...
//
//	mockgen -package client -build_constraint !ignore_autogenerated -destination internal/mocks/client/mock.go github.com/bakito/adguardhome-sync/internal/client Client
//
