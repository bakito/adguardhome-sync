...
//
//	mockgen -package client -build_constraint !ignore_autogenerated -destination internal/mocks/flags/mock.go github.com/bakito/adguardhome-sync/internal/config Flags
//
