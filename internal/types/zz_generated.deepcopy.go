...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FiltersType) DeepCopyInto(out *FiltersType) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FiltersType.
func (in *FiltersType) DeepCopy() *FiltersType {
	if in == nil {
		return nil
	}
	out := new(FiltersType)
...
func (in *Replica) DeepCopyInto(out *Replica) {
	*out = *in
	in.AdGuardInstance.DeepCopyInto(&out.AdGuardInstance)
	if in.Features != nil {
